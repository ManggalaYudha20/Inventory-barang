                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php 
                                    $i = 1;
                                    $ambilsemuadatadepartemen = mysqli_query($conn, "select * from departemen");
                                    while($data=mysqli_fetch_array($ambilsemuadatadepartemen)){
                                        $namadepartemen = $data['namadepartemen'];
                                        $keterangan = $data['keterangan'];
                                        $idd = $data['iddepartemen'];
                                    ?>
                                        <tr>
                                            <td><?=$i++;?></td>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="text" name="namadepartemen" value="<?=$namadepartemen;?>" class="form-control" required>
                                                            <br>
                                                        ...
                                                        <button type="submit" class="btn btn-primary" name="updatedepartemen"> Edit </button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            yakin ingin menghapus <?=$namadepartemen;?> ?
                                                        ...
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                        <button type="submit" class="btn btn-danger" name="hapusdepartemen"> Hapus </button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <input type="text" name="namadepartemen" placeholder="Departemen" class="form-control"required>
        <br>
        ...
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" name="addnewdepartemen"> Submit </button>
        </div>
        </form>
