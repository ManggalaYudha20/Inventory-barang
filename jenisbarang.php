                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?=$keterangan;?></td>
                                            <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?=$idj;?>">
                                             Edit
                                            </button> 

                                            <button  type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?=$idj;?>">
                                             Delete
                                            </button>
                                            </td>
                                        </tr>
                                        ...
                                        <!-- Modal EDIT -->
                                        <div class="modal fade" id="edit<?=$idj;?>">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="text" name="namajenis" value="<?=$namajenis;?>" class="form-control" required>
                                                            <br>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            yakin ingin menghapus <?=$namajenis;?> ?
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <input type="text" name="namajenis" placeholder="Jenis" class="form-control"required>
        <br>
        ...
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" name="addnewjenis"> Submit </button>
        </div>
        </form>
