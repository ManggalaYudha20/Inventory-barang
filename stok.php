                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <i class="fas fa-plus"></i> Tambah Barang Stok 
                                </button>
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Tambah Barang Stok </h4>
          <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        ...
        <br>
        <input type="text" name="deskripsi" placeholder="Deskripsi" value="-" class="form-control">
        <br>
        <input type="number" name="stok" placeholder="Stok" value="0" min="0" class="form-control"required>
        <br>
        ...
        <br>
        <select name="namasatuan" class="form-control">
            <?php
             $ambilsemuadatanya = mysqli_query($conn, "select * from satuan");
             while($fetcharray = mysqli_fetch_array($ambilsemuadatanya)){
                $namasatuan = $fetcharray['namasatuan'];
                $idsatuan = $fetcharray['idsatuan'];

            ?>
            <option value="<?=$namasatuan;?>">
            <?=$namasatuan;?>
             </option>
